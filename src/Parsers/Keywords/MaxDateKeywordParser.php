...
use Systopia\JsonSchema\Keywords\MaxDateKeyword;

class MaxDateKeywordParser extends KeywordParser
{
    use DataKeywordTrait;

    public function __construct()
    {
        parent::__construct('maxDate');
    }
    ...
    public function parse(SchemaInfo $info, SchemaParser $parser, object $shared): ?Keyword
    {
        ...
        return new MaxDateKeyword(Variable::create($value, $parser));
    }
}
